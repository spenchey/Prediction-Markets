...
async def lifespan(app: FastAPI):
    ...
    async def on_trade_for_position_tracking(trade):
        ...
        # Skip KALSHI_ANON - it's not a real wallet, just a placeholder
        # because Kalshi doesn't expose trader identities
        if trade.trader_address in ("KALSHI_ANON", "UNKNOWN", None, ""):
            return
        ...
        if position_tracker:
            ...
            # Handle any accumulation alerts (these should be rare with proper thresholds)
